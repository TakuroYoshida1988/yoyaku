...
店舗名（50文字以内）, 地域ID（下記の対応表を参照）, ジャンルID（下記の対応表を参照）, 店舗概要（400文字以内）, 画像URL（アクセス可能で'https://' や'http://'から始まり、拡張子はjpg・jpeg・pngのいずれかであることを確認してください。例: 'https://example.com/image.jpg'）
